...
class AgencySystem:
    ...
    """
    def __init__(self, limbic=None, control=None):
        ...
        try:
            ...
            if self.limbic:
                ...
                logger.info("[AGENCY] Agency system initialized (no limbic system)")
    ...
    def get_tier(self) -> TrustTier:
        ...
        if not self.limbic:
            return TrustTier.ASSOCIATE  # Default tier when no limbic
